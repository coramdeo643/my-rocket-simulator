...
mixin _$ChecklistItem {
 ...
 String get id; LaunchStage get targetStage; String get description; bool get isCompleted;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,targetStage,description,isCompleted);

@override
String toString() {
  return 'ChecklistItem(id: $id, targetStage: $targetStage, description: $description, isCompleted: $isCompleted)';
}
...
@useResult
$Res call({
 String id, LaunchStage targetStage, String description, bool isCompleted
});
...
/// Create a copy of ChecklistItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? targetStage = null,Object? description = null,Object? isCompleted = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  LaunchStage targetStage,  String description,  bool isCompleted)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChecklistItem() when $default != null:
return $default(_that.id,_that.targetStage,_that.description,_that.isCompleted);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  LaunchStage targetStage,  String description,  bool isCompleted)  $default,) {final _that = this;
switch (_that) {
case _ChecklistItem():
return $default(_that.id,_that.targetStage,_that.description,_that.isCompleted);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  LaunchStage targetStage,  String description,  bool isCompleted)?  $default,) {final _that = this;
switch (_that) {
case _ChecklistItem() when $default != null:
return $default(_that.id,_that.targetStage,_that.description,_that.isCompleted);case _:
  return null;
...
class _ChecklistItem implements ChecklistItem {
  const _ChecklistItem({required this.id, required this.targetStage, required this.description, this.isCompleted = false});
...
/// Create a copy of ChecklistItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? targetStage = null,Object? description = null,Object? isCompleted = null,}) {
